...
from services.safe_http import SafeHTTPError, safe_get_bytes_sync
...
def _load_image(image_path: str) -> tuple[bytes, str]:
    try:
        ...
        raise
    except (OSError, requests.RequestException, SafeHTTPError) as exc:
